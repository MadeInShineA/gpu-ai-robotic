...
TARGET_NAME:=Student_Cuda_Image_${USER}
...
override SRC_AUX+=#
#override SRC_AUX+=../Student_Cuda_Tools_Reduction/src/01_cudatools
...
include $(API_BACKEND_TP)/bilat_backend_tp_cuda_image.mk
