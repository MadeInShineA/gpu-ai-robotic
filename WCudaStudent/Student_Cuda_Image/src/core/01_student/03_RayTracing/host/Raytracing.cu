...
extern __global__ void kernelRaytacingGM(uchar4 *tabPixelsGM, uint w, uint h, float t, Sphere *tabSpheresGM, int nbSpheres);
extern __global__ void kernelRaytacingSM(uchar4 *tabPixelsGM, uint w, uint h, float t, Sphere *tabSpheresGM, int nbSpheres);
extern __global__ void kernelRaytacingCM(uchar4 *tabPixelsGM, uint w, uint h, float t, int nbSpheres);
extern __global__ void kernelRaytacingCM2SM(uchar4 *tabPixelsGM, uint w, uint h, float t, int nbSpheres);

extern __host__ void uploadToCM(Sphere *tabSpheres, int nbSpheres);
